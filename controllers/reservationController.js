const getReservation = async (req, res) => {
    try {
        res.send(await knex('reservations').join('residents', 'reservations.resident_id', 'residents.id').select('residents.name', 'reservations.place', 'reservations.date')).orderBy('update_at')
    } catch (err) {
